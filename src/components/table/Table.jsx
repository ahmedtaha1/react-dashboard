  ...
  return (
    <TableContainer component={Paper} className="table">
      <Table
        ...
        className="tablContent"
      >
        <TableHead>
          <TableRow>
            <TableCell className="cell">Tracking ID</TableCell>
            <TableCell className="cell">Product</TableCell>
            <TableCell className="cell">Customer</TableCell>
            <TableCell className="cell">Date</TableCell>
            <TableCell className="cell">Amount</TableCell>
            <TableCell className="cell">Payment Method</TableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.id}>
              ...
              <TableCell className="cell">{row.method}</TableCell>
              <TableCell className="cell">
